      ...
      <div className="flex flex-1 flex-col gap-3 overflow-hidden p-3">
        ...
        <div className="flex min-w-0 gap-2">
          <button
            ...
            className="inline-flex min-w-0 shrink-0 cursor-pointer items-center justify-center gap-1 rounded-lg bg-green-600 px-3 py-2.5 text-xs font-semibold text-white shadow-sm hover:bg-green-700"
          >
            WELL DONE
          </button>
          <button
            type="button"
            onClick={sendToAi}
            className="inline-flex min-w-0 flex-1 cursor-pointer items-center justify-center gap-2 rounded-lg bg-indigo-600 py-2.5 text-sm font-semibold text-white shadow-md shadow-indigo-600/20 hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 disabled:cursor-not-allowed disabled:opacity-50"
