...
| **`babel-plugin-clipper-qa.js`** | Плагин: при включённом флаге добавляет `data-qa-*` на JSX **вне** каталога `plugins/clipper-qa/`; для entry при отсутствии импорта/JSX `ClipperQA` вставляет импорт и виджет в конец `<body>` или корня.                                                                                                                |
| **`ClipperQA.tsx`**              | Корневой виджет: композиция хуков и подкомпонентов.                                                                                                                                                                                                                                                                    |
| **`BugListItem.tsx`**            | Строка списка багов (анимация, описание, удаление).                                                                                                                                                                                                                                                                    |
| **`ClipperQaCollapsed.tsx`**     | Свёрнутое состояние (кнопка «жук»).                                                                                                                                                                                                                                                                                     |
| **`ClipperQaHeader.tsx`**        | Шапка панели: Clear all, Inspect, Collapse.                                                                                                                                                                                                                                                                            |
| **`ClipperQaFooter.tsx`**        | Подсказки и нижние кнопки (`default` / `copyinfo`).                                                                                                                                                                                                                                                                     |
| **`constants.ts`**               | Ключи LocalStorage, стили outline, класс `WIDGET_INTERACTIVE_CLASS`.                                                                                                                                                                                                                                                   |
| **`domCapture.ts`**              | DOM-хелперы: hit-test, `captureContextFromElement`, курсор.                                                                                                                                                                                                                                                             |
| **`clipboard.ts`**               | `copyTextToClipboard`.                                                                                                                                                                                                                                                                                                |
| **`clipperQaMode.ts`**           | `getClipperQaActionMode()`.                                                                                                                                                                                                                                                                                            |
| **`clipperQaApi.ts`**            | `postBugsToAi`, `postWellDoneCommand` (POST JSON).                                                                                                                                                                                                                                                                      |
| **`useClipperQaStorage.ts`**     | Гидратация и синхронизация `localStorage` для expanded / bugs / wellDone.                                                                                                                                                                                                                                              |
| **`useClipperQaHoverOutline.ts`**| Глобальные слушатели hover-подсветки (Alt / Inspect).                                                                                                                                                                                                                                                                   |
| **`useClipperQaCapture.ts`**     | Перехват mousedown/up/click для клипа элемента.                                                                                                                                                                                                                                                                        |
...
- **Чистота репозитория:** в исходниках нет лишних `data-qa-*`; они появляются только в сборке/деве, когда флаг включён. JSX **внутри** `plugins/clipper-qa/` (виджет и подкомпоненты) не размечается.
