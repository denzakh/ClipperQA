/**
 * ClipperQA Babel plugin (development only).
 * - Injects data-qa-file / data-qa-component on JSX (except this module).
 * - Injects import + <ClipperQA /> into app entry files (layout / App).
 */
